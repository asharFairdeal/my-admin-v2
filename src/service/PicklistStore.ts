...
class PickListStoreClass {
    async getList(queryParams: any) {
        const response:any = await apiService.get(apiUrls.pickerUrl + '/get-all-picklist' ,  queryParams, true);
        return  {
    ...
    async updateStatus(data : any) {
        return apiService.put(apiUrls.pickerUrl + '/update-picklist-status' , data)
    }
...
export const PickListStore = new PickListStoreClass();
