...
class DropZoneStoreClass {
    async getList(queryParams: any) {
        const response:any = await apiService.get(apiUrls.pickerUrl + '/get-all-dropzone' ,  queryParams, true);
        return  {
...
export const DropZoneStore = new DropZoneStoreClass();
